...
const USER_DATA = [
    ...
    { "id": 2, "firstName": "Username", "lastName": "9", "fullName": "Username 9", "date": "5/1/2023", "profileImage": userName9, "comment": "sit amet turpis elementum ligula vehicula consequat morbi a ipsum integer a nibh in quis justo maecenas" },
    { "id": 3, "firstName": "Username", "lastName": "10", "fullName": "Username 10", "date": "4/19/2023", "profileImage": userName10, "comment": "in faucibus orci luctus et ultrices posuere cubilia curae nulla dapibus dolor vel est donec odio justo sollicitudin ut suscipit" },
    { "id": 4, "firstName": "Username", "lastName": "7", "fullName": "Username 7", "date": "4/22/2023", "profileImage": userName7, "comment": "in congue etiam justo etiam pretium iaculis justo in hac habitasse platea dictumst" },
    ...
    { "id": 9, "firstName": "Username", "lastName": "5", "fullName": "Username 5", "date": "6/23/2023", "profileImage": userName5, "comment": "sed ante vivamus tortor duis mattis egestas metus aenean fermentum donec ut mauris eget massa tempor convallis nulla neque libero" },
    { "id": 10, "firstName": "Username", "lastName": "1", "fullName": "Username 1", "date": "6/25/2023", "profileImage": userName1, "comment": "nisl duis bibendum felis sed interdum venenatis turpis enim blandit mi in" }]


const MyProfileCommentsSection = () => {
...
export default MyProfileCommentsSection;